  ...
  <div className="courseOutline">
    ...
    {outline.info.educationalGoals ? (
      <>
        ...
        <div className="userTextContent">
          <p
            dangerouslySetInnerHTML={{ __html: outline.info.educationalGoals }}
          ></p>
        </div>
      </>
    ) : null}
    ...
    <div className="disclaimer">
      <p>
        ...
        <a href={`http://www.sfu.ca/outlines.html/${outline.info.outlinePath}`}>
          official outline
        </a>
      ...
      <p>
        Instructors: visit{' '}
        <a href="http://outlines.sfu.ca">http://outlines.sfu.ca</a> to update
        this course outline
      </p>
    </div>
  </div>
